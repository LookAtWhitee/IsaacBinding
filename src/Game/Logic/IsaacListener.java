        ...
        synchronized (key) {
            if (!key.contains(e.getKeyChar())) {
                ...
                if (isaac.state == State.Alive) {
                    switch (e.getKeyChar()) {
                        case 'w':
                            isaac.currentDirection = Direction.Up;
                            isaac.lastDirection = Direction.Up;
                            break;
                        case 's':
                            isaac.currentDirection = Direction.Down;
                            isaac.lastDirection = Direction.Down;
                            break;
                        case 'a':
                            isaac.currentDirection = Direction.Left;
                            isaac.lastDirection = Direction.Left;
                            break;
                        case 'd':
                            isaac.currentDirection = Direction.Right;
                            isaac.lastDirection = Direction.Right;
                            break;
                        case ' ':
                            Updater.shoot(isaac);
                            break;
